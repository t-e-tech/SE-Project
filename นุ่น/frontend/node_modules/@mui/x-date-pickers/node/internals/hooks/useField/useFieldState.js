...
const useFieldState = params => {
  ...
  const getSectionsFromValue = React.useCallback((value, fallbackSections = null) => fieldValueManager.getSectionsFromValue(utils, value, fallbackSections, isRTL, date => (0, _useField.splitFormatIntoSections)(utils, localeText, format, date)), [fieldValueManager, format, localeText, isRTL, utils]);
